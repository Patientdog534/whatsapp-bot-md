...
module.exports = {
  ...
  SUDO: process.env.SUDO || '2349120730021',
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME,
  HEROKU_API_KEY: process.env.HEROKU_API_KEY,
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '𖣘𝑴𝑨𝑿𝑾𝑬𝑳𝑳-𝑴𝑫♡●',
  ...
  ANTILINK_MSG: process.env.ANTILINK_MSG || '_Antilink Detected &mention kicked By MAXWELL (2349120730021)_',
  ANTISPAM_MSG: process.env.ANTISPAM_MSG || '_Antispam Detected &mention kicked BY MAXWELL (2349120730021)_',
  ANTIWORDS_MSG: process.env.ANTIWORDS_MSG || '_AntiWord Detected &mention kicked BY MAXWELLL (2349120730021)_',
  ...
  ADMINS: process.env.GROUP_ADMINS || '2349120730021',
}
